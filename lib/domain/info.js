...
exports.updateStudentAttendance = exports.extractAttendance = exports.getPreviousAttendance = exports.addNewAttendance = exports.getStudentList = exports.getAllCourses = exports.getAllUniversities = void 0;
...
var extractAttendance = function extractAttendance(courseID, year, month, day) {
  var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
  var currentdateString = monthNames[month - 1] + " " + day.toString() + "," + year.toString() + " 00:00:00 UTC";
  var currentDate = new Date(currentdateString);
  currentDate = currentDate.toISOString();
  var nextDate = new Date(currentdateString);
  nextDate.setDate(nextDate.getDate() + 1);
  nextDate = nextDate.toISOString();
  return (0, _info.extractAttendanceFromDb)(courseID, currentDate, nextDate).then(function (attendance) {
    return attendance[0].studentID.map(function (student) {
      return {
        name: student.firstname + " " + student.lastname,
        id: student._id,
        roll: student.enrollmentNumber
...
exports.extractAttendance = extractAttendance;

var updateStudentAttendance = function updateStudentAttendance(studentIdList, studentRollList, courseID, univID, year, month, day) {
  return (0, _info.extractStudentID)(univID, studentRollList).then(function (students) {
    var addedStudentIds = students.map(function (student) {
      return student._id;
    });
    var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    var currentdateString = monthNames[month - 1] + " " + day.toString() + "," + year.toString() + " 00:00:00 UTC";
    ...
    nextDate.setDate(nextDate.getDate() + 1);
    nextDate = nextDate.toISOString();
    return (0, _info.updateStudentAttendanceInDB)([].concat(_toConsumableArray(studentIdList), _toConsumableArray(addedStudentIds)), courseID, currentDate, nextDate).then(function () {
      return true;
    });
  })["catch"](function () {
    return false;
