...
var updateStudentAttendanceInDB = function updateStudentAttendanceInDB(studentIds, courseId, currentDate, nextDate) {
  return _models.StudentAttendance.findOneAndUpdate({
    course: _mongoose["default"].Types.ObjectId(courseId),
    lectureDate: {
      $gt: currentDate,
      $lt: nextDate
...
exports.updateStudentAttendanceInDB = updateStudentAttendanceInDB;